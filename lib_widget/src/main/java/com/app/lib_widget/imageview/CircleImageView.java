package com.app.lib_widget.imageview;
...
public class CircleImageView  extends ImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = a.hasValue(R.styleable.CircleImageView_image_type) ? a.getInt(R.styleable.CircleImageView_image_type, MODE_NONE) : MODE_NONE;
        currRound = a.hasValue(R.styleable.CircleImageView_radius_size) ? a.getDimensionPixelSize(R.styleable.CircleImageView_radius_size, currRound) : currRound;
        a.recycle();
    }
...
//                canvas.drawCircle(getWidth() / 2, getHeight() / 2, getWidth() / 2, paint);
    ...
    private Bitmap drawable2Bitmap(Drawable drawable) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(getWidth() == 0 ? 1 : getWidth(), getHeight() == 0 ? 1 : getHeight(), Bitmap.Config.ARGB_8888);
