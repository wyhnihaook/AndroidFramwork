...
import com.app.lib_widget.swiprecyclerview.touch.DefaultItemTouchHelper;
import com.app.lib_widget.swiprecyclerview.touch.OnItemMoveListener;
import com.app.lib_widget.swiprecyclerview.touch.OnItemMovementListener;
import com.app.lib_widget.swiprecyclerview.touch.OnItemStateChangedListener;
import com.app.lib_widget.swiprecyclerview.widget.DefaultLoadMoreView;
...
public class SwipeRecyclerView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (adapter == null) {
            ...
            if(confirmOperator){
                //需要额外确认的情况,才进行处理
                mAdapterWrapper.setConfirmInfo(true,confirmText,confirmIndex);
            }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                //重置操作过的item信息
                if(mAdapterWrapper!=null){
                    mAdapterWrapper.resetConfirmText();
                }
                break;
            case MotionEvent.ACTION_UP:
                break;
