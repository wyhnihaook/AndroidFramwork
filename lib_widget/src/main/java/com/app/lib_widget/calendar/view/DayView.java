...
public final class DayView extends LinearLayout {
    ...
    private void initialize(Context context) {
        ...
        setBackgroundColor(Color.parseColor("#161718"));
    ...
    public void value(DayEntity entity) {
        ...
        Log.e("wyh","entity="+new Gson().toJson(entity));
        this.entity = entity;
        //内容
    ...
    private void setBackgroundStatus(DayEntity entity) {
        switch (entity.status()) {
            ...
            case Status.RANGE:
            case Status.STRESS:
                setBackgroundColor(ContextCompat.getColor(getContext(), R.color.calendar_day_background_range_color2));
                setEnabled(true);
                break;
            //左边界
            case Status.BOUND_L:
                tvDay.setTextColor(ContextCompat.getColor(getContext(), R.color.calendar_day_text_range_color));
                tvDesc.setTextColor(ContextCompat.getColor(getContext(), R.color.calendar_day_text_range_color));
