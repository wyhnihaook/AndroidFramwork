...
import com.app.lib_widget.calendar.annotation.Status;
import com.app.lib_widget.calendar.protocol.DayEntity;
import com.app.lib_widget.calendar.protocol.MonthEntity;
import com.app.lib_widget.calendar.protocol.NInterval;
import com.app.lib_widget.calendar.protocol.OnMonthClickListener;
...
public class MonthView extends ViewGroup {
    ...
    public MonthView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundColor(ContextCompat.getColor(context, R.color.calendar_month_background_color2));
        //DayView
        ...
        for (int j = 0; j < lines.length; j++) {
            ...
            view.setBackgroundResource(R.color.calendar_month_divide_line_color2);
            addView(view);
            lines[j] = view;
        }
        ...
        for (int index = 0, move = position + 1; index < dayViews.length; index++, move++) {
            ...
            if (index < offset) {
                ...
                dayEntity = DayEntity.obtain(Status.NORMAL, index, isToday ? MonthEntity.STR_TODAY : "")
                        ...
                        .descStatus(isToday ? Status.NORMAL : Status.NORMAL);
                //valid
