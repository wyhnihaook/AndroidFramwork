...
package com.app.lib_widget.timer;
...
import com.app.lib_widget.timer.animation.TimelyEvaluator;
import com.app.lib_widget.timer.model.NumberUtils;
...
public class TimelyView extends View {
    ...
    public TimelyView(Context context, AttributeSet attrs) {
        ...
        textColor = typedArray.getColor(R.styleable.TimelyView_time_text_color, Color.BLACK);
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heigthWithoutPadding = height - getPaddingTop() - getPaddingBottom() + 10;
        ...
        if (widthWithoutPadding > maxWidth) {
            ...
            height = maxHeight + getPaddingTop() + getPaddingBottom() + 10;
        }
